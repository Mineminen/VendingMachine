...
<table style=" width: 100%;">
    <tr>
        <td style="text-align:center;    font-size: 20px; font-family: " 微软雅黑";">${helps.htitle}</td>
    </tr>
    <tr>
        <td style="text-align:center;">发布时间：${helps.addtime}&nbsp;&nbsp;</td>
    </tr>
    <tr>
        <td style="text-indent:24px;">${helps.hdetail}</td>
    </tr>
</table>
