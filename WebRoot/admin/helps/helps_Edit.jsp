                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <form  action="<%=path %>/helpsEdit.action" method="post"  id="form1">
    <table style="width: 100%;" >
        
<tr><td  style="text-align:right; width:20%;">
<font style='color:red'>*&nbsp;</font>标题:</td><td>
<input name="htitle" type="text" id="htitle" style="width: 200px;" required  value='${helps.htitle}' />
 </td></tr>
...
<textarea id="hdetail"  name="hdetail" cols="100" rows="8" style="width:700px;height:400px;visibility:hidden;">${helps.hdetail}</textarea>
 </td></tr>
        ...
        <tr>
            <td>&nbsp;</td>
            <td align="left">
                <input name="hid" type="hidden"  value='<%= request.getParameter("id") %>'>
