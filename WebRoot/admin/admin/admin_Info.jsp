                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <form  action="<%=path %>/adminInfo.action" method="post"  id="form1">

    <table style="width: 100%;" >
        <tr><td  style="text-align:right; width:20%;">
<font style='color:red'>*&nbsp;</font>ID:</td><td>
<input name="aid1" type="text" id="aid" style="width: 200px;"  disabled="disabled"  required  value='${admin.aid}' />
 </td></tr>
...
<input name="sf" type="text" id="sf" style="width: 200px;" required  value='${admin.sf}' />
        ...
        <tr>
            <td>&nbsp;</td>
            <td align="left">
                <input name="aid" type="hidden"  value='${admin.aid}'>
