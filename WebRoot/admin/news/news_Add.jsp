...
<textarea id="nmemo"  name="nmemo" cols="100" rows="8" style="width:700px;height:400px;visibility:hidden;"></textarea>
 </td></tr>
        ...
        <tr>
            ...
            <td align="left">
                ...
                <input name="btnReturn" type="button" value="返 回"   class=" btn btn-yellow btn-w-md"  onclick="location.href='<%=path %>/newsList.action';"  />
            </td>
        </tr>
    </table>
</form>
