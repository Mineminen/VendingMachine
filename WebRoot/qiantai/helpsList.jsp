...
<pg:pager  url="helps_List.action" items="${itemSize}" maxPageItems="${pageItem}"
...
<table style="width:100%;border-bottom: 1px dashed #000;" class="tablelist">
    <tbody>
        <tr>
            <td> <a href="<%=path%>/helpsView.action?id=${helps.hid}">${helps.htitle}</a></td>
            <td width="30%" align="right">发布时间：${helps.addtime}</td>
        </tr>
    </tbody>
</table>
